    ...
    WEBHOOK_PATH = f"/webhook/{WEBHOOK_SECRET}"  # должно быть: /webhook/cheongjutaxi
    ...
    async def lifespan(app: FastAPI):
        ...
        await dp.start_polling(bot, polling=False)
    ...
    async def telegram_webhook(request: Request):
        ...
        print("📩 Webhook received:", body.decode())  # ← лог запроса
